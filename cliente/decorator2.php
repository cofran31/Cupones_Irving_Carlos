...
class Book{
  ...
  private $categoria14;
  private $categoria15;
    function __construct($categoria1_in, $categoria2_in, $categoria3_in, $categoria4_in, $categoria5_in, $categoria6_in,
                       $categoria7_in, $categoria8_in, $categoria9_in, $categoria10_in, $categoria11_in, $categoria12_in,
                       $categoria13_in, $categoria14_in, $categoria15_in) {
  ...
  <div class="agileits_header">
    ...
    <div class="w3l_search">
      <form action="#" method="post">
        <input type="text" name="Product" value="Buscar Productos..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Buscar Productos...';}" required="">
       ...
       <!-- Brand and toggle get grouped for better mobile display -->
        ...
        <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
          <ul class="nav navbar-nav nav_1">
            <li><a href="products.html"><?php $iniciarDecorator->iniciarMayuscula(); echo $decorator->showCategoria1() ?></a></li>
            <li><a href="household.html"><?php $iniciarDecorator->iniciarMayuscula(); echo $decorator->showCategoria2() ?></a></li>
            <li class="dropdown mega-dropdown active">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php $iniciarDecorator->iniciarMayuscula(); echo $decorator->showCategoria3() ?><span class="caret"></span></a>        
              <div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
                <div class="w3ls_vegetables">
                  <ul>  
                    <li><a href="vegetables.html"><?php $iniciarDecorator->iniciarMayuscula(); echo $decorator->showCategoria4() ?></a></li>
                    <li><a href="vegetables.html"><?php $iniciarDecorator->iniciarMayuscula(); echo $decorator->showCategoria5() ?></a></li>
                  </ul>
                </div>                  
              </div>        
            </li>
            <li><a href="kitchen.html"><?php $iniciarDecorator->iniciarMayuscula(); echo $decorator->showCategoria6() ?></a></li>
            <li><a href="short-codes.html"><?php $iniciarDecorator->iniciarMayuscula(); echo $decorator->showCategoria7() ?></a></li>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php $iniciarDecorator->iniciarMayuscula(); echo $decorator->showCategoria8() ?><span class="caret"></span></a>
              <div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
                <div class="w3ls_vegetables">
                  <ul>
                    <li><a href="drinks.html"><?php $iniciarDecorator->iniciarMayuscula(); echo $decorator->showCategoria9() ?></a></li>
                    <li><a href="drinks.html"><?php $iniciarDecorator->iniciarMayuscula(); echo $decorator->showCategoria10() ?></a></li>
                  </ul>
                </div>                  
              </div>  
            </li>
            <li><a href="pet.html"><?php $iniciarDecorator->iniciarMayuscula(); echo $decorator->showCategoria11() ?></a></li>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php $iniciarDecorator->iniciarMayuscula(); echo $decorator->showCategoria12() ?><span class="caret"></span></a>
              <div class="dropdown-menu mega-dropdown-menu w3ls_vegetables_menu">
                <div class="w3ls_vegetables">
                  <ul>
                    <li><a href="frozen.html"><?php $iniciarDecorator->iniciarMayuscula(); echo $decorator->showCategoria13() ?></a></li>
                    <li><a href="frozen.html"><?php $iniciarDecorator->iniciarMayuscula(); echo $decorator->showCategoria14() ?></a></li>
                  </ul>
                </div>                  
              </div>  
            </li>
            <li><a href="bread.html"><?php $iniciarDecorator->iniciarMayuscula(); echo $decorator->showCategoria15() ?></a></li>
          </ul>
         </div><!-- /.navbar-collapse -->
      </nav>
    </div>
